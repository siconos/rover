...
extern  void
Distance(double *CD, double gamma, double *AngleT, double *q);
/**			 	    
...
extern void 
RRV(double RootRotationVector[4],  double q[21]);

//extern void 
//PRV(double PlaneRotationVector[4], double AngleT[4], double q[21]);
