...
#include "RoverViewer.hpp"

using namespace qglviewer;

bool FullScreen = false;
void RoverViewer::init()
{
  // viewer and scene state
  restoreStateFromFile();
  setSceneRadius(90.);// 300-230
  showEntireScene();
...
void RoverViewer::draw()
{
  ...
  for (boost::tie(ui,uiend)=I1->vertices();ui!=uiend;++ui)
  {
    ...
    if (Type::value(*relation) != Type::LagrangianScleronomousR)
    {
...
void RoverViewer::mousePressEvent(QMouseEvent* e)
{
...
void RoverViewer::mouseMoveEvent(QMouseEvent *e)
{
...
void RoverViewer::mouseReleaseEvent(QMouseEvent* e)
{
  if (myMouseBehavior_)
    myMouseBehavior_ = false;
...
QString RoverViewer::helpString() const
{
