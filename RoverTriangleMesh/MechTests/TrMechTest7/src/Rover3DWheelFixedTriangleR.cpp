...
SiconosVector Rover3DWheelFixedTriangleR::computeWheelNorm(double* tags)
{

  int index = _id / NUMOFWHEELS;

  SiconosVector wheelNorm(3);
  ...
  case 0:
    ...
    wheelNorm.setValue(0, tags[26]);
    wheelNorm.setValue(1, tags[70]);
    wheelNorm.setValue(2, tags[114]);

    wheelCenter.setValue(0, tags[7]);
    wheelCenter.setValue(1, tags[51]);
    wheelCenter.setValue(2, tags[95]);

    wheelNorm = wheelNorm - wheelCenter;
  ...
  case 1:
    ...
    wheelNorm.setValue(0, tags[29]);
    wheelNorm.setValue(1, tags[73]);
    wheelNorm.setValue(2, tags[117]);
  ...
  case 2:
    ...
    wheelNorm.setValue(0, tags[32]);
    wheelNorm.setValue(1, tags[76]);
    wheelNorm.setValue(2, tags[120]);
  ...
  case 3:
    ...
    wheelNorm.setValue(0, tags[35]);
    wheelNorm.setValue(1, tags[79]);
    wheelNorm.setValue(2, tags[123]);
  ...
  case 4:
    ...
    wheelNorm.setValue(0, tags[38]);
    wheelNorm.setValue(1, tags[82]);
    wheelNorm.setValue(2, tags[126]);
  ...
  case 5:
    ...
    wheelNorm.setValue(0, tags[41]);
    wheelNorm.setValue(1, tags[85]);
    wheelNorm.setValue(2, tags[129]);
...
void Rover3DWheelFixedTriangleR::computeNormalAndDistance(SiconosVector wheelCenter)
{
  ...
  /*finding a normal based on where the contact point projects*/
  ...
  if(triangle.checkIfInsideMe(proj)){
    ...
    if(edge1.checkIfInsideMe(proj)){
      ...
      edge1._n.setValue(0, 0.707);
      edge1._n.setValue(1, 0.0);
      edge1._n.setValue(2, 0.707);

      if((abs(edge1._p1.getValue(2) - edge1._p2.getValue(2)) < 10e-6) && (abs(edge1._p1.getValue(2) - edge1._p2.getValue(2)) > -10e-6))
    ...
    if(edge2.checkIfInsideMe(proj)){
      ...
      edge2._n.setValue(0, 0.707);
      edge2._n.setValue(1, 0.0);
      edge2._n.setValue(2, 0.707);

      if((abs(edge2._p1.getValue(2) - edge2._p2.getValue(2)) < 10e-6) && (abs(edge2._p1.getValue(2) - edge2._p2.getValue(2)) > -10e-6))
    ...
    if(edge3.checkIfInsideMe(proj)){
      ...
      edge3._n.setValue(0, 0.707);
      edge3._n.setValue(1, 0.0);
      edge3._n.setValue(2, 0.707);

      if((abs(edge3._p1.getValue(2) - edge3._p2.getValue(2)) < 10e-6) && (abs(edge3._p1.getValue(2) - edge3._p2.getValue(2)) > -10e-6))
