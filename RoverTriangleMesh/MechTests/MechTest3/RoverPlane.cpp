...
int main(int argc, char* argv[])
{
  try
  {
    ...
    double T = 400;                 // final computation time
    ...
    while(s->hasNextEvent())
    {
      ...
      (*Force)(9) = 700;       //FL traction
      (*Force)(10) = 700;      //FR  traction
      (*Force)(14) = 700;      //ML traction
      (*Force)(15) = 700;      //BL traction
      (*Force)(19) = 700;      //MR traction
      (*Force)(20) = 700;     //BR traction
      }
      ...
      /*if(dataPlot(k, 0) > 150){
      (*Force)(9) = -500;       //FL traction
      (*Force)(10) = -500;      //FR  traction
      (*Force)(14) = -500;      //ML traction
      (*Force)(15) = -500;      //BL traction
      (*Force)(19) = -500;      //MR traction
      (*Force)(20) = -500;     //BR traction
      }*/

      if(dataPlot(k, 0) > 150 && dataPlot(k, 0) < 300){

        if((*v)(0) > -10e-4 && (*v)(0) < 10e-4){
