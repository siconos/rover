...
#mass center
t, x, y, z, r1, r2, r3 = np.loadtxt('VELOCITY.dat', usecols=(0, 1, 2, 3, 4, 5, 6), unpack=True)
...
#plt.title(r'$x_{wheels}$ $velocity$')
#plt.xlabel(r'$T [s]$')
#plt.ylabel(r'$x_{wheels}$ $velocity$ $[\frac{rad}{s}]$')
