...
double qdot[21];
{
  ...
  double tmp4 = -pow(C4 * C3 * qdot[5] - S3 * qdot[4], 2) - pow(C4 * S3 * qdot[5] + C3 * qdot[4], 2);
  double tmp5 = (C4 * S3 * qdot[5] + C3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  double tmp6 = -pow(C4 * S3 * qdot[5] + C3 * qdot[4], 2) - pow(qdot[3] - S4 * qdot[5], 2);
  double tmp7 = (C4 * C3 * qdot[5] - S3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  double tmp8 = (C4 * C3 * qdot[5] - S3 * qdot[4]) * (C4 * S3 * qdot[5] + C3 * qdot[4]);
  double tmp9 = (C4 * C3 * qdot[5] - S3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  double tmp10 = (C4 * S3 * qdot[5] + C3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  double tmp11 = (C4 * C3 * qdot[5] - S3 * qdot[4]) * (C4 * S3 * qdot[5] + C3 * qdot[4]);
  double tmp12 = -pow(C4 * C3 * qdot[5] - S3 * qdot[4], 2) - pow(qdot[3] - S4 * qdot[5], 2);
  double tmp13 = 700 * tmp1;
  double tmp14 = 700 * tmp2;
  double tmp15 = 700 * tmp3;
  double tmp16 = (C4 * S3 * qdot[5] + C3 * qdot[4]) * (0.2800000e7 / 0.3e1 * C4 * C3 * qdot[5] - 0.2800000e7 / 0.3e1 * S3 * qdot[4]) - (C4 * C3 * qdot[5] - S3 * qdot[4]) * (0.4270000e7 / 0.3e1 * C4 * S3 * qdot[5] + 0.4270000e7 / 0.3e1 * C3 * qdot[4]);
  double tmp17 = (C4 * C3 * qdot[5] - S3 * qdot[4]) * (0.2030000e7 / 0.3e1 * qdot[3] - 0.2030000e7 / 0.3e1 * S4 * qdot[5]) - (qdot[3] - S4 * qdot[5]) * (0.2800000e7 / 0.3e1 * C4 * C3 * qdot[5] - 0.2800000e7 / 0.3e1 * S3 * qdot[4]);
  ...
  double tmp24 = tmp1 + 62 * tmp4 - 10 * tmp5;
  double tmp25 = C6 * (tmp2 + 62 * tmp10 - 10 * tmp12) + S6 * (tmp3 + 62 * tmp9 - 10 * tmp8);
  double tmp26 = -S6 * (tmp2 + 62 * tmp10 - 10 * tmp12) + C6 * (tmp3 + 62 * tmp9 - 10 * tmp8);
  double tmp29 = -tmp20 * tmp20 - pow(tmp19 + qdot[6], 2);
  ...
  double tmp46 = C7 * (tmp24 - 53 * tmp30) - S7 * (tmp26 - 53 * tmp29);
  double tmp47 = tmp25 - 53 * tmp34;
  double tmp48 = S7 * (tmp24 - 53 * tmp30) + C7 * (tmp26 - 53 * tmp29);
  double tmp50 = -tmp45 + (tmp20 + qdot[7]) * tmp42;
  double tmp53 = tmp44 + tmp43 * (tmp20 + qdot[7]);
  ...
  double tmp68 = C9 * (tmp46 - 15 * tmp50) + S9 * (tmp47 - 15 * tmp57);
  double tmp69 = -S9 * (tmp46 - 15 * tmp50) + C9 * (tmp47 - 15 * tmp57);
  double tmp70 = tmp48 - 15 * tmp53;
  ...
  double tmp112 = C8 * (tmp24 + 53 * tmp30) - S8 * (tmp26 + 53 * tmp29);
  double tmp113 = tmp25 + 53 * tmp34;
  double tmp114 = S8 * (tmp24 + 53 * tmp30) + C8 * (tmp26 + 53 * tmp29);
  double tmp116 = -tmp111 + (tmp20 + qdot[8]) * tmp108;
  double tmp119 = tmp110 + tmp109 * (tmp20 + qdot[8]);
  ...
  double tmp134 = C10 * (tmp112 - 15 * tmp116) + S10 * (tmp113 - 15 * tmp123);
  double tmp135 = -S10 * (tmp112 - 15 * tmp116) + C10 * (tmp113 - 15 * tmp123);
  double tmp136 = tmp114 - 15 * tmp119;
  ...
  double tmp190 = C11 * (tmp1 - 40 * tmp4 - 10 * tmp5 - 53 * tmp7) + S11 * (tmp2 - 40 * tmp10 - 10 * tmp12 - 53 * tmp11);
  double tmp191 = -S11 * (tmp1 - 40 * tmp4 - 10 * tmp5 - 53 * tmp7) + C11 * (tmp2 - 40 * tmp10 - 10 * tmp12 - 53 * tmp11);
  double tmp192 = tmp3 - 40 * tmp9 - 10 * tmp8 - 53 * tmp6;
  double tmp193 = -pow(tmp187 + qdot[11], 2) - tmp186 * tmp186;
  ...
  double tmp212 = C12 * (tmp190 + 30 * tmp193) - S12 * (tmp192 + 30 * tmp198);
  double tmp213 = tmp191 + 30 * tmp199;
  double tmp214 = S12 * (tmp190 + 30 * tmp193) + C12 * (tmp192 + 30 * tmp198);
  double tmp216 = -tmp211 + (tmp186 + qdot[12]) * tmp208;
  double tmp219 = tmp210 + tmp209 * (tmp186 + qdot[12]);
  ...
  double tmp234 = C14 * (tmp212 - 15 * tmp216) + S14 * (tmp213 - 15 * tmp223);
  double tmp235 = -S14 * (tmp212 - 15 * tmp216) + C14 * (tmp213 - 15 * tmp223);
  double tmp236 = tmp214 - 15 * tmp219;
  ...
  double tmp278 = C13 * (tmp190 - 30 * tmp193) - S13 * (tmp192 - 30 * tmp198);
  double tmp279 = tmp191 - 30 * tmp199;
  double tmp280 = S13 * (tmp190 - 30 * tmp193) + C13 * (tmp192 - 30 * tmp198);
  double tmp282 = -tmp277 + (tmp186 + qdot[13]) * tmp274;
  double tmp285 = tmp276 + tmp275 * (tmp186 + qdot[13]);
  ...
  double tmp300 = C15 * (tmp278 - 15 * tmp282) + S15 * (tmp279 - 15 * tmp289);
  double tmp301 = -S15 * (tmp278 - 15 * tmp282) + C15 * (tmp279 - 15 * tmp289);
  double tmp302 = tmp280 - 15 * tmp285;
  ...
  double tmp356 = C16 * (tmp1 - 40 * tmp4 - 10 * tmp5 + 53 * tmp7) + S16 * (tmp2 - 40 * tmp10 - 10 * tmp12 + 53 * tmp11);
  double tmp357 = -S16 * (tmp1 - 40 * tmp4 - 10 * tmp5 + 53 * tmp7) + C16 * (tmp2 - 40 * tmp10 - 10 * tmp12 + 53 * tmp11);
  double tmp358 = tmp3 - 40 * tmp9 - 10 * tmp8 + 53 * tmp6;
  double tmp359 = -pow(tmp353 + qdot[16], 2) - tmp352 * tmp352;
  ...
  double tmp378 = C17 * (tmp356 + 30 * tmp359) - S17 * (tmp358 + 30 * tmp364);
  double tmp379 = tmp357 + 30 * tmp365;
  double tmp380 = S17 * (tmp356 + 30 * tmp359) + C17 * (tmp358 + 30 * tmp364);
  double tmp382 = -tmp377 + (tmp352 + qdot[17]) * tmp374;
  double tmp385 = tmp376 + tmp375 * (tmp352 + qdot[17]);
  ...
  double tmp400 = C19 * (tmp378 - 15 * tmp382) + S19 * (tmp379 - 15 * tmp389);
  double tmp401 = -S19 * (tmp378 - 15 * tmp382) + C19 * (tmp379 - 15 * tmp389);
  double tmp402 = tmp380 - 15 * tmp385;
  ...
  double tmp444 = C18 * (tmp356 - 30 * tmp359) - S18 * (tmp358 - 30 * tmp364);
  double tmp445 = tmp357 - 30 * tmp365;
  double tmp446 = S18 * (tmp356 - 30 * tmp359) + C18 * (tmp358 - 30 * tmp364);
  double tmp448 = -tmp443 + (tmp352 + qdot[18]) * tmp440;
  double tmp451 = tmp442 + tmp441 * (tmp352 + qdot[18]);
  ...
  double tmp466 = C20 * (tmp444 - 15 * tmp448) + S20 * (tmp445 - 15 * tmp455);
  double tmp467 = -S20 * (tmp444 - 15 * tmp448) + C20 * (tmp445 - 15 * tmp455);
  double tmp468 = tmp446 - 15 * tmp451;
