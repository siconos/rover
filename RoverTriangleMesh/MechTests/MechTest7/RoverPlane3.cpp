...
int main(int argc, char* argv[])
{
  try
  {
    ...
    /*(*q0)(7) = 0.707;       //FL traction
    (*q0)(8) = 0.407;      //FR  traction
    (*q0)(12) = 0;      //ML traction
    (*q0)(17) = 0;      //BL traction
    (*q0)(13) = -0.707;      //MR traction
    (*q0)(18) = -0.407;     //BR traction*/

    (*q0)(7) = 0.407;       //FL traction
    (*q0)(8) = 0.107;      //FR  traction
    (*q0)(12) = 0;      //ML traction
    (*q0)(17) = 0;      //BL traction
    (*q0)(13) = -0.407;      //MR traction
    (*q0)(18) = -0.107;     //BR traction
    ...
    while(s->hasNextEvent())
    {
      ...
      static_torque = 550*(*v)(0) - 30*(8000 - (*q)(0));

      if(dataPlot(k, 0) >= 50 && dataPlot(k, 0) < 110){

        (*Force)(9) = 7500;       //FL traction
        (*Force)(10) = 7500;      //FR  traction
        (*Force)(14) = 7500;      //ML traction
        (*Force)(15) = 7500;      //BL traction
        (*Force)(19) = 7500;      //MR traction
        (*Force)(20) = 7500;      //BR traction
     ...
     /*if(dataPlot(k, 0) >= 110 && dataPlot(k, 0) < 150){

        (*Force)(9) = 1000;       //FL traction
        (*Force)(10) = 1000;      //FR  traction
        (*Force)(14) = 1000;      //ML traction
        (*Force)(15) = 1000;      //BL traction
        (*Force)(19) = 1000;      //MR traction
        (*Force)(20) = 1000;      //BR traction
      ...
      if(dataPlot(k, 0) >= 110){
        ...
        if((*Force)(20) == 0){
          ...
          (*Force)(9) = 7500 - ii*4;       //FL traction
          (*Force)(10) = 7500 - ii*4;      //FR  traction
          (*Force)(14) = 7500 - ii*4;      //ML traction
          (*Force)(15) = 7500 - ii*4;      //BL traction
          (*Force)(19) = 7500 - ii*4;      //MR traction
          (*Force)(20) = 7500 - ii*4;      //BR traction
