...
#y component sphere
t, y1, y2, y3, y4, y5, y6 = np.loadtxt('YDOTS.dat', usecols=(0, 19, 22, 25, 28, 31, 34), unpack=True)

#x component sphere
#t, y1, y2, y3, y4, y5, y6 = np.loadtxt('YDOTS.dat', usecols=(0, 20, 23, 26, 29, 32, 35), unpack=True)

#z component sphere
#t, y1, y2, y3, y4, y5, y6 = np.loadtxt('YDOTS.dat', usecols=(0, 21, 24, 27, 30, 33, 36), unpack=True)
