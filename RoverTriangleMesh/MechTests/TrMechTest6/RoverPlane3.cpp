  ...
  try
  {
    ...
    for(int j = 0; j < 6; ++j){
      ...
      for(outerIt = outerVec.begin(), p = 0; outerIt != outerVec.end(); ++outerIt, ++p){
        ...
        relationS[j*NumTr + p].reset(new Rover3DWheelFixedSphereR(j, sRad, 50, 50, -1.80, R));
    ...
    while(s->hasNextEvent())
    {
      ...
      if(dataPlot(k, 0) > 10){
        ...
        // (*Force)(9) = static_torque + 3*(*v)(0) - 1*(40.0 - (*q)(0));  //FL traction
        // (*Force)(10) = static_torque + 3*(*v)(0) - 1*(40.0 - (*q)(0)); //FR  traction
        // (*Force)(14) = static_torque + 3*(*v)(0) - 1*(40.0 - (*q)(0)); //ML traction
        // (*Force)(15) = static_torque + 3*(*v)(0) - 1*(40.0 - (*q)(0)); //BL traction
        // (*Force)(19) = static_torque + 3*(*v)(0) - 1*(40.0 - (*q)(0)); //MR traction
        // (*Force)(20) = static_torque + 3*(*v)(0) - 1*(40.0 - (*q)(0)); //BR traction

        (*Force)(9) = static_torque - 0.0015*(47.0 - (*q)(0));  //FL traction
        (*Force)(10) = static_torque - 0.0015*(47.0 - (*q)(0)); //FR  traction
        (*Force)(14) = static_torque - 0.0015*(47.0 - (*q)(0)); //ML traction
        (*Force)(15) = static_torque - 0.0015*(47.0 - (*q)(0)); //BL traction
        (*Force)(19) = static_torque - 0.0015*(47.0 - (*q)(0)); //MR traction
        (*Force)(20) = static_torque - 0.0015*(47.0 - (*q)(0)); //BR traction
