...
set output "Velocity-trunk".extension
...
set origin hoffset,(winheight*3.0+0.10)+heightoff
...
set yrange [0:torque_max] 
plot "DoublePendulumResult.dat"  using 1:39  notitle w lines
