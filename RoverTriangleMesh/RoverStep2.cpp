...
int main(int argc, char* argv[])
{
  try
  {
    ...
    double T = 170;                 // final computation time
    ...
    while(s->hasNextEvent())
    {
      ...
      if(dataPlot(k, 0) > 30 && dataPlot(k, 0) <= 180){
      (*Force)(9) = -22000;       //FL traction
      (*Force)(10) = -22000;      //FR  traction
      (*Force)(14) = -22000;      //ML traction
      (*Force)(15) = -22000;      //BL traction
      (*Force)(19) = -22000;      //MR traction
      (*Force)(20) = -22000;     //BR traction
      }


      /*if(dataPlot(k, 0) > 180 && dataPlot(k, 0) <= 220){
      (*Force)(9) = 1900;       //FL traction
      (*Force)(10) = 1900;      //FR  traction
      (*Force)(14) = 1900;      //ML traction
      (*Force)(15) = 1900;      //BL traction
      (*Force)(19) = 1900;      //MR traction
      (*Force)(20) = 1900;     //BR traction
      }
