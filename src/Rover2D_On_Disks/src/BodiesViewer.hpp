...
public:
  ...
  void visit(SP::ExternalBody b)
  {
    SP::Drawing drawing(new Drawing(b));
    drawing->setID(i_);
    drawing->saveFExt();
    viewer_->drawings_.push_back(drawing);
  }
...
public:
  ...
  void visit(SP::ExternalBody body)
  {
    SP::Rover rover = boost::static_pointer_cast<Rover>(body);
    ...
    viewer_->drawDisk(rover->q()->getValue(0)-rover->length()*cos(rover->q()->getValue(2)),
                      rover->q()->getValue(1)-rover->length()*sin(rover->q()->getValue(2)),
                      rover->q()->getValue(3),
                      rover->wheelRadius(),c);
    ...
    viewer_->drawRec(rover->q()->getValue(0)-rover->length()*cos(rover->q()->getValue(2)),
                     rover->q()->getValue(1)-rover->length()*sin(rover->q()->getValue(2)),
                     rover->q()->getValue(0)+rover->length()*cos(rover->q()->getValue(2)),
                     rover->q()->getValue(1)+rover->length()*sin(rover->q()->getValue(2)),
                     .3,
                     .1);
...
public:
  ...
  void visit(SP::ExternalBody rover)
  {}
