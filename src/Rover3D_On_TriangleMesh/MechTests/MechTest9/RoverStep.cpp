...
int main(int argc, char* argv[])
{
  try
  {
    ...
    for(int j = 0; j < 6; ++j){
      ...
      //relation[j*NumTr + 1].reset(new Rover3DWheelFixedTriangleR(1000, 5, 0, 1000, 5, 1000, 1000, 0, 0, j, R, (j*NumTr + 1)));
      //relation[j*NumTr + 2].reset(new Rover3DWheelFixedTriangleR(1000, 5, 1000, 1000, 0, 1000, 1000, 0, 0, j, R, (j*NumTr + 2)));
      //relation[j*NumTr + 3].reset(new Rover3DWheelFixedTriangleR(1000, 5, 0, 1000, 5, 1000, 2000, 5, 500, j, R, (j*NumTr + 3)));
