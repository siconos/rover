...
double qdot[21];
{
  ...
  double tmp4 = -pow(C3 * C4 * qdot[5] - S3 * qdot[4], 2) - pow(qdot[3] - S4 * qdot[5], 2);
  double tmp5 = (C4 * S3 * qdot[5] + C3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  double tmp6 = (C3 * C4 * qdot[5] - S3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  double tmp7 = (C4 * S3 * qdot[5] + C3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  double tmp8 = -pow(C3 * C4 * qdot[5] - S3 * qdot[4], 2) - pow(C4 * S3 * qdot[5] + C3 * qdot[4], 2);
  double tmp9 = (C3 * C4 * qdot[5] - S3 * qdot[4]) * (C4 * S3 * qdot[5] + C3 * qdot[4]);
  double tmp10 = -pow(C4 * S3 * qdot[5] + C3 * qdot[4], 2) - pow(qdot[3] - S4 * qdot[5], 2);
  double tmp11 = (C3 * C4 * qdot[5] - S3 * qdot[4]) * (C4 * S3 * qdot[5] + C3 * qdot[4]);
  double tmp12 = (C3 * C4 * qdot[5] - S3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  ...
  double tmp24 = tmp1 + 62 * tmp8 - 10 * tmp7;
  double tmp25 = C6 * (tmp2 + 62 * tmp5 - 10 * tmp4) + S6 * (tmp3 + 62 * tmp12 - 10 * tmp9);
  double tmp26 = -S6 * (tmp2 + 62 * tmp5 - 10 * tmp4) + C6 * (tmp3 + 62 * tmp12 - 10 * tmp9);
  double tmp29 = tmp22 + tmp21 * (tmp19 + qdot[6]);
  ...
  double tmp46 = C7 * (tmp24 - 53 * tmp29) - S7 * (tmp26 - 53 * tmp33);
  double tmp47 = tmp25 - 53 * tmp34;
  double tmp48 = S7 * (tmp24 - 53 * tmp29) + C7 * (tmp26 - 53 * tmp33);
  double tmp49 = -tmp43 * tmp43 - tmp42 * tmp42;
  double tmp52 = -tmp45 + (tmp20 + qdot[7]) * tmp42;
  double tmp54 = tmp44 + tmp43 * (tmp20 + qdot[7]);
  ...
  double tmp68 = C9 * (tmp46 - 15 * tmp52) + S9 * (tmp47 - 15 * tmp49);
  double tmp69 = -S9 * (tmp46 - 15 * tmp52) + C9 * (tmp47 - 15 * tmp49);
  double tmp70 = tmp48 - 15 * tmp54;
  double tmp80 = 14 * tmp68;
  double tmp81 = 14 * tmp69;
  double tmp82 = 14 * tmp70;
  double tmp83 = 3150 * tmp66 + tmp65 * (6300 * tmp43 + 6300 * qdot[9]) - 3150 * (tmp43 + qdot[9]) * tmp65;
  double tmp84 = 3150 * tmp67 + 3150 * (tmp43 + qdot[9]) * tmp64 - tmp64 * (6300 * tmp43 + 6300 * qdot[9]);
  double tmp85 = 6300 * tmp45;
  ...
  double tmp112 = C8 * (tmp24 + 53 * tmp29) - S8 * (tmp26 + 53 * tmp33);
  double tmp113 = tmp25 + 53 * tmp34;
  double tmp114 = S8 * (tmp24 + 53 * tmp29) + C8 * (tmp26 + 53 * tmp33);
  double tmp115 = -tmp109 * tmp109 - tmp108 * tmp108;
  double tmp118 = -tmp111 + (tmp20 + qdot[8]) * tmp108;
  double tmp120 = tmp110 + tmp109 * (tmp20 + qdot[8]);
  ...
  double tmp134 = C10 * (tmp112 - 15 * tmp118) + S10 * (tmp113 - 15 * tmp115);
  double tmp135 = -S10 * (tmp112 - 15 * tmp118) + C10 * (tmp113 - 15 * tmp115);
  double tmp136 = tmp114 - 15 * tmp120;
  double tmp146 = 14 * tmp134;
  double tmp147 = 14 * tmp135;
  double tmp148 = 14 * tmp136;
  double tmp149 = 3150 * tmp132 + tmp131 * (6300 * tmp109 + 6300 * qdot[10]) - 3150 * (tmp109 + qdot[10]) * tmp131;
  double tmp150 = 3150 * tmp133 + 3150 * (tmp109 + qdot[10]) * tmp130 - tmp130 * (6300 * tmp109 + 6300 * qdot[10]);
  double tmp151 = 6300 * tmp111;
  ...
  double tmp190 = C11 * (tmp1 - 40 * tmp8 - 10 * tmp7 - 53 * tmp6) + S11 * (tmp2 - 40 * tmp5 - 10 * tmp4 - 53 * tmp11);
  double tmp191 = -S11 * (tmp1 - 40 * tmp8 - 10 * tmp7 - 53 * tmp6) + C11 * (tmp2 - 40 * tmp5 - 10 * tmp4 - 53 * tmp11);
  double tmp192 = tmp3 - 40 * tmp12 - 10 * tmp9 - 53 * tmp10;
  double tmp194 = tmp186 * tmp185;
  double tmp197 = -pow(tmp187 + qdot[11], 2) - tmp186 * tmp186;
  double tmp201 = -tmp189 + (tmp187 + qdot[11]) * tmp185;
  ...
  double tmp212 = C12 * (tmp190 + 30 * tmp197) - S12 * (tmp192 + 30 * tmp201);
  double tmp213 = tmp191 + 30 * tmp194;
  double tmp214 = S12 * (tmp190 + 30 * tmp197) + C12 * (tmp192 + 30 * tmp201);
  double tmp215 = -tmp209 * tmp209 - tmp208 * tmp208;
  double tmp218 = -tmp211 + (tmp186 + qdot[12]) * tmp208;
  double tmp220 = tmp210 + tmp209 * (tmp186 + qdot[12]);
  ...
  double tmp234 = C14 * (tmp212 - 15 * tmp218) + S14 * (tmp213 - 15 * tmp215);
  double tmp235 = -S14 * (tmp212 - 15 * tmp218) + C14 * (tmp213 - 15 * tmp215);
  double tmp236 = tmp214 - 15 * tmp220;
  double tmp246 = 14 * tmp234;
  double tmp247 = 14 * tmp235;
  double tmp248 = 14 * tmp236;
  double tmp249 = 3150 * tmp232 + tmp231 * (6300 * tmp209 + 6300 * qdot[14]) - 3150 * (tmp209 + qdot[14]) * tmp231;
  double tmp250 = 3150 * tmp233 + 3150 * (tmp209 + qdot[14]) * tmp230 - tmp230 * (6300 * tmp209 + 6300 * qdot[14]);
  double tmp251 = 6300 * tmp211;
  ...
  double tmp278 = C13 * (tmp190 - 30 * tmp197) - S13 * (tmp192 - 30 * tmp201);
  double tmp279 = tmp191 - 30 * tmp194;
  double tmp280 = S13 * (tmp190 - 30 * tmp197) + C13 * (tmp192 - 30 * tmp201);
  double tmp281 = -tmp275 * tmp275 - tmp274 * tmp274;
  double tmp284 = -tmp277 + (tmp186 + qdot[13]) * tmp274;
  double tmp286 = tmp276 + tmp275 * (tmp186 + qdot[13]);
  ...
  double tmp300 = C15 * (tmp278 - 15 * tmp284) + S15 * (tmp279 - 15 * tmp281);
  double tmp301 = -S15 * (tmp278 - 15 * tmp284) + C15 * (tmp279 - 15 * tmp281);
  double tmp302 = tmp280 - 15 * tmp286;
  double tmp312 = 14 * tmp300;
  double tmp313 = 14 * tmp301;
  double tmp314 = 14 * tmp302;
  double tmp315 = 3150 * tmp298 + tmp297 * (6300 * tmp275 + 6300 * qdot[15]) - 3150 * (tmp275 + qdot[15]) * tmp297;
  double tmp316 = 3150 * tmp299 + 3150 * (tmp275 + qdot[15]) * tmp296 - tmp296 * (6300 * tmp275 + 6300 * qdot[15]);
  double tmp317 = 6300 * tmp277;
  ...
  double tmp356 = C16 * (tmp1 - 40 * tmp8 - 10 * tmp7 + 53 * tmp6) + S16 * (tmp2 - 40 * tmp5 - 10 * tmp4 + 53 * tmp11);
  double tmp357 = -S16 * (tmp1 - 40 * tmp8 - 10 * tmp7 + 53 * tmp6) + C16 * (tmp2 - 40 * tmp5 - 10 * tmp4 + 53 * tmp11);
  double tmp358 = tmp3 - 40 * tmp12 - 10 * tmp9 + 53 * tmp10;
  double tmp360 = tmp352 * tmp351;
  double tmp363 = -pow(tmp353 + qdot[16], 2) - tmp352 * tmp352;
  double tmp367 = -tmp355 + (tmp353 + qdot[16]) * tmp351;
  ...
  double tmp378 = C17 * (tmp356 + 30 * tmp363) - S17 * (tmp358 + 30 * tmp367);
  double tmp379 = tmp357 + 30 * tmp360;
  double tmp380 = S17 * (tmp356 + 30 * tmp363) + C17 * (tmp358 + 30 * tmp367);
  double tmp381 = -tmp375 * tmp375 - tmp374 * tmp374;
  double tmp384 = -tmp377 + (tmp352 + qdot[17]) * tmp374;
  double tmp386 = tmp376 + tmp375 * (tmp352 + qdot[17]);
  ...
  double tmp400 = C19 * (tmp378 - 15 * tmp384) + S19 * (tmp379 - 15 * tmp381);
  double tmp401 = -S19 * (tmp378 - 15 * tmp384) + C19 * (tmp379 - 15 * tmp381);
  double tmp402 = tmp380 - 15 * tmp386;
  double tmp412 = 14 * tmp400;
  double tmp413 = 14 * tmp401;
  double tmp414 = 14 * tmp402;
  double tmp415 = 3150 * tmp398 + tmp397 * (6300 * tmp375 + 6300 * qdot[19]) - 3150 * (tmp375 + qdot[19]) * tmp397;
  double tmp416 = 3150 * tmp399 + 3150 * (tmp375 + qdot[19]) * tmp396 - tmp396 * (6300 * tmp375 + 6300 * qdot[19]);
  double tmp417 = 6300 * tmp377;
  ...
  double tmp444 = C18 * (tmp356 - 30 * tmp363) - S18 * (tmp358 - 30 * tmp367);
  double tmp445 = tmp357 - 30 * tmp360;
  double tmp446 = S18 * (tmp356 - 30 * tmp363) + C18 * (tmp358 - 30 * tmp367);
  double tmp447 = -tmp441 * tmp441 - tmp440 * tmp440;
  double tmp450 = -tmp443 + (tmp352 + qdot[18]) * tmp440;
  double tmp452 = tmp442 + tmp441 * (tmp352 + qdot[18]);
  ...
  double tmp466 = C20 * (tmp444 - 15 * tmp450) + S20 * (tmp445 - 15 * tmp447);
  double tmp467 = -S20 * (tmp444 - 15 * tmp450) + C20 * (tmp445 - 15 * tmp447);
  double tmp468 = tmp446 - 15 * tmp452;
  double tmp478 = 14 * tmp466;
  double tmp479 = 14 * tmp467;
  double tmp480 = 14 * tmp468;
  double tmp481 = 3150 * tmp464 + tmp463 * (6300 * tmp441 + 6300 * qdot[20]) - 3150 * (tmp441 + qdot[20]) * tmp463;
  double tmp482 = 3150 * tmp465 + 3150 * (tmp441 + qdot[20]) * tmp462 - tmp462 * (6300 * tmp441 + 6300 * qdot[20]);
  double tmp483 = 6300 * tmp443;
