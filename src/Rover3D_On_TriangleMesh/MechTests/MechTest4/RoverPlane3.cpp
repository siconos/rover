...
int main(int argc, char* argv[])
{
  try
  {
    ...
    double T = 300;                 // final computation time
    ...
    while(s->hasNextEvent())
    {
      ...
      if(dataPlot(k, 0) > 5 && dataPlot(k, 0) < 200){
      ...
      if(dataPlot(k, 0) >= 200){
        ...
        (*Force)(9) = 9500;       //FL traction
        (*Force)(10) = 9500;      //FR  traction
        (*Force)(14) = 9500;      //ML traction
        (*Force)(15) = 9500;      //BL traction
        (*Force)(19) = 9500;      //MR traction
        (*Force)(20) = 9500;      //BR traction
