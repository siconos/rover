...
int main(int argc, char* argv[])
{
  try
  {
    ...
    while(s->hasNextEvent())
    {
      ...
      (*Force)(9) = 0.0007;       //FL traction
      (*Force)(10) = 0.0007;      //FR  traction
      (*Force)(14) = 0.0007;      //ML traction
      (*Force)(15) = 0.0007;      //BL traction
      (*Force)(19) = 0.0007;      //MR traction
      (*Force)(20) = 0.0007;     //BR traction
      }
