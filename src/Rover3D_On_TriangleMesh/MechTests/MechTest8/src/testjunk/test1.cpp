...
double distFromSegment(vect P, vect A, vect B)
{
...
int main()
{
  ...
  double b = distFromSegment(point, seg1, seg2);
  double c = distFromSegment(point, seg2, seg1);
  double d = distFromSegment(point2, seg1, seg2);
  ...
  */
  ...
  vect d1(5, 4, 3), d2(6, 7, 1);

  double result1 = dotProd(d1, d2);
  double result2 = dotProd(d2, d1);
