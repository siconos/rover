...
int main(int argc, char* argv[])
{
  try
  {
    ...
    double T = 70;                 // final computation time
    ...
    while(s->hasNextEvent())
    {
      ...
      //to measuer when the rover stops
      /*if((*v)(0) < 0.0005 && (*v)(0) > -0.0005){

        cout << dataPlot(k, 0) << endl;
        
      }*/

      if(dataPlot(k, 0) > 2.0 && dataPlot(k, 0) < 30){

        (*Force)(9) = static_torque + 2*(*v)(0) - 0.7*(70.0 - (*q)(0));       //FL traction
        (*Force)(10) = static_torque + 2*(*v)(0) - 0.7*(70.0 - (*q)(0));      //FR  traction
        (*Force)(14) = static_torque + 2*(*v)(0) - 0.7*(70.0 - (*q)(0));      //ML traction
        (*Force)(15) = static_torque + 2*(*v)(0) - 0.7*(70.0 - (*q)(0));      //BL traction
        (*Force)(19) = static_torque + 2*(*v)(0) - 0.7*(70.0 - (*q)(0));      //MR traction
        (*Force)(20) = static_torque + 2*(*v)(0) - 0.7*(70.0 - (*q)(0));      //BR traction
