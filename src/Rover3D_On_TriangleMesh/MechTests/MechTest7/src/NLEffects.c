...
double qdot[21];
{
  ...
  double tmp4 = (C4 * C3 * qdot[5] - S3 * qdot[4]) * (S3 * C4 * qdot[5] + C3 * qdot[4]);
  double tmp5 = -pow(C4 * C3 * qdot[5] - S3 * qdot[4], 2) - pow(-S4 * qdot[5] + qdot[3], 2);
  double tmp6 = (C4 * C3 * qdot[5] - S3 * qdot[4]) * (S3 * C4 * qdot[5] + C3 * qdot[4]);
  double tmp7 = -pow(S3 * C4 * qdot[5] + C3 * qdot[4], 2) - pow(-S4 * qdot[5] + qdot[3], 2);
  double tmp8 = (C4 * C3 * qdot[5] - S3 * qdot[4]) * (-S4 * qdot[5] + qdot[3]);
  double tmp9 = -pow(C4 * C3 * qdot[5] - S3 * qdot[4], 2) - pow(S3 * C4 * qdot[5] + C3 * qdot[4], 2);
  double tmp10 = (S3 * C4 * qdot[5] + C3 * qdot[4]) * (-S4 * qdot[5] + qdot[3]);
  double tmp11 = (C4 * C3 * qdot[5] - S3 * qdot[4]) * (-S4 * qdot[5] + qdot[3]);
  double tmp12 = (S3 * C4 * qdot[5] + C3 * qdot[4]) * (-S4 * qdot[5] + qdot[3]);
  double tmp13 = 700 * tmp1;
  double tmp14 = 700 * tmp2;
  double tmp15 = 700 * tmp3;
  double tmp16 = (S3 * C4 * qdot[5] + C3 * qdot[4]) * (0.2800000e7 / 0.3e1 * C4 * C3 * qdot[5] - 0.2800000e7 / 0.3e1 * S3 * qdot[4]) - (C4 * C3 * qdot[5] - S3 * qdot[4]) * (0.4270000e7 / 0.3e1 * S3 * C4 * qdot[5] + 0.4270000e7 / 0.3e1 * C3 * qdot[4]);
  double tmp17 = (C4 * C3 * qdot[5] - S3 * qdot[4]) * (-0.2030000e7 / 0.3e1 * S4 * qdot[5] + 0.2030000e7 / 0.3e1 * qdot[3]) - (-S4 * qdot[5] + qdot[3]) * (0.2800000e7 / 0.3e1 * C4 * C3 * qdot[5] - 0.2800000e7 / 0.3e1 * S3 * qdot[4]);
  double tmp18 = (-S4 * qdot[5] + qdot[3]) * (0.4270000e7 / 0.3e1 * S3 * C4 * qdot[5] + 0.4270000e7 / 0.3e1 * C3 * qdot[4]) - (S3 * C4 * qdot[5] + C3 * qdot[4]) * (-0.2030000e7 / 0.3e1 * S4 * qdot[5] + 0.2030000e7 / 0.3e1 * qdot[3]);
  ...
  double tmp24 = tmp1 + 62 * tmp9 - 10 * tmp10;
  double tmp25 = C6 * (tmp2 + 62 * tmp12 - 10 * tmp5) + S6 * (tmp3 + 62 * tmp8 - 10 * tmp6);
  double tmp26 = -S6 * (tmp2 + 62 * tmp12 - 10 * tmp5) + C6 * (tmp3 + 62 * tmp8 - 10 * tmp6);
  double tmp27 = tmp21 * tmp20;
  ...
  double tmp46 = C7 * (tmp24 - 53 * tmp34) - S7 * (tmp26 - 53 * tmp30);
  double tmp47 = tmp25 - 53 * tmp27;
  double tmp48 = S7 * (tmp24 - 53 * tmp34) + C7 * (tmp26 - 53 * tmp30);
  double tmp50 = -tmp43 * tmp43 - tmp42 * tmp42;
  double tmp51 = tmp44 + tmp43 * (tmp20 + qdot[7]);
  double tmp55 = -tmp45 + (tmp20 + qdot[7]) * tmp42;
  ...
  double tmp68 = C9 * (tmp46 - 15 * tmp55) + S9 * (tmp47 - 15 * tmp50);
  double tmp69 = -S9 * (tmp46 - 15 * tmp55) + C9 * (tmp47 - 15 * tmp50);
  ...
  double tmp112 = C8 * (tmp24 + 53 * tmp34) - S8 * (tmp26 + 53 * tmp30);
  double tmp113 = tmp25 + 53 * tmp27;
  double tmp114 = S8 * (tmp24 + 53 * tmp34) + C8 * (tmp26 + 53 * tmp30);
  double tmp116 = -tmp109 * tmp109 - tmp108 * tmp108;
  double tmp117 = tmp110 + tmp109 * (tmp20 + qdot[8]);
  double tmp121 = -tmp111 + (tmp20 + qdot[8]) * tmp108;
  ...
  double tmp134 = C10 * (tmp112 - 15 * tmp121) + S10 * (tmp113 - 15 * tmp116);
  double tmp135 = -S10 * (tmp112 - 15 * tmp121) + C10 * (tmp113 - 15 * tmp116);
  ...
  double tmp185 = C11 * (-S4 * qdot[5] + qdot[3]) + S11 * (S3 * C4 * qdot[5] + C3 * qdot[4]);
  double tmp186 = -S11 * (-S4 * qdot[5] + qdot[3]) + C11 * (S3 * C4 * qdot[5] + C3 * qdot[4]);
  double tmp187 = C4 * C3 * qdot[5] - S3 * qdot[4];
  double tmp188 = tmp186 * qdot[11];
  double tmp189 = -tmp185 * qdot[11];
  double tmp190 = C11 * (tmp1 - 40 * tmp9 - 10 * tmp10 - 53 * tmp11) + S11 * (tmp2 - 40 * tmp12 - 10 * tmp5 - 53 * tmp4);
  double tmp191 = -S11 * (tmp1 - 40 * tmp9 - 10 * tmp10 - 53 * tmp11) + C11 * (tmp2 - 40 * tmp12 - 10 * tmp5 - 53 * tmp4);
  double tmp192 = tmp3 - 40 * tmp8 - 10 * tmp6 - 53 * tmp7;
  ...
  double tmp212 = C12 * (tmp190 + 30 * tmp198) - S12 * (tmp192 + 30 * tmp197);
  double tmp213 = tmp191 + 30 * tmp201;
  double tmp214 = S12 * (tmp190 + 30 * tmp198) + C12 * (tmp192 + 30 * tmp197);
  double tmp216 = -tmp209 * tmp209 - tmp208 * tmp208;
  double tmp217 = tmp210 + tmp209 * (tmp186 + qdot[12]);
  double tmp221 = -tmp211 + (tmp186 + qdot[12]) * tmp208;
  ...
  double tmp234 = C14 * (tmp212 - 15 * tmp221) + S14 * (tmp213 - 15 * tmp216);
  double tmp235 = -S14 * (tmp212 - 15 * tmp221) + C14 * (tmp213 - 15 * tmp216);
  ...
  double tmp278 = C13 * (tmp190 - 30 * tmp198) - S13 * (tmp192 - 30 * tmp197);
  double tmp279 = tmp191 - 30 * tmp201;
  double tmp280 = S13 * (tmp190 - 30 * tmp198) + C13 * (tmp192 - 30 * tmp197);
  double tmp282 = -tmp275 * tmp275 - tmp274 * tmp274;
  double tmp283 = tmp276 + tmp275 * (tmp186 + qdot[13]);
  double tmp287 = -tmp277 + (tmp186 + qdot[13]) * tmp274;
  ...
  double tmp300 = C15 * (tmp278 - 15 * tmp287) + S15 * (tmp279 - 15 * tmp282);
  double tmp301 = -S15 * (tmp278 - 15 * tmp287) + C15 * (tmp279 - 15 * tmp282);
  ...
  double tmp351 = C16 * (-S4 * qdot[5] + qdot[3]) + S16 * (S3 * C4 * qdot[5] + C3 * qdot[4]);
  double tmp352 = -S16 * (-S4 * qdot[5] + qdot[3]) + C16 * (S3 * C4 * qdot[5] + C3 * qdot[4]);
  double tmp353 = C4 * C3 * qdot[5] - S3 * qdot[4];
  double tmp354 = tmp352 * qdot[16];
  double tmp355 = -tmp351 * qdot[16];
  double tmp356 = C16 * (tmp1 - 40 * tmp9 - 10 * tmp10 + 53 * tmp11) + S16 * (tmp2 - 40 * tmp12 - 10 * tmp5 + 53 * tmp4);
  double tmp357 = -S16 * (tmp1 - 40 * tmp9 - 10 * tmp10 + 53 * tmp11) + C16 * (tmp2 - 40 * tmp12 - 10 * tmp5 + 53 * tmp4);
  double tmp358 = tmp3 - 40 * tmp8 - 10 * tmp6 + 53 * tmp7;
  ...
  double tmp378 = C17 * (tmp356 + 30 * tmp364) - S17 * (tmp358 + 30 * tmp363);
  double tmp379 = tmp357 + 30 * tmp367;
  double tmp380 = S17 * (tmp356 + 30 * tmp364) + C17 * (tmp358 + 30 * tmp363);
  double tmp382 = -tmp375 * tmp375 - tmp374 * tmp374;
  double tmp383 = tmp376 + tmp375 * (tmp352 + qdot[17]);
  double tmp387 = -tmp377 + (tmp352 + qdot[17]) * tmp374;
  ...
  double tmp400 = C19 * (tmp378 - 15 * tmp387) + S19 * (tmp379 - 15 * tmp382);
  double tmp401 = -S19 * (tmp378 - 15 * tmp387) + C19 * (tmp379 - 15 * tmp382);
  ...
  double tmp444 = C18 * (tmp356 - 30 * tmp364) - S18 * (tmp358 - 30 * tmp363);
  double tmp445 = tmp357 - 30 * tmp367;
  double tmp446 = S18 * (tmp356 - 30 * tmp364) + C18 * (tmp358 - 30 * tmp363);
  double tmp448 = -tmp441 * tmp441 - tmp440 * tmp440;
  double tmp449 = tmp442 + tmp441 * (tmp352 + qdot[18]);
  double tmp453 = -tmp443 + (tmp352 + qdot[18]) * tmp440;
  ...
  double tmp466 = C20 * (tmp444 - 15 * tmp453) + S20 * (tmp445 - 15 * tmp448);
  double tmp467 = -S20 * (tmp444 - 15 * tmp453) + C20 * (tmp445 - 15 * tmp448);
