...
double qdot[21];
{
  ...
  double tmp4 = -pow(S3 * C4 * qdot[5] + C3 * qdot[4], 2) - pow(qdot[3] - S4 * qdot[5], 2);
  double tmp5 = (C3 * C4 * qdot[5] - S3 * qdot[4]) * (S3 * C4 * qdot[5] + C3 * qdot[4]);
  double tmp6 = (C3 * C4 * qdot[5] - S3 * qdot[4]) * (S3 * C4 * qdot[5] + C3 * qdot[4]);
  double tmp7 = -pow(C3 * C4 * qdot[5] - S3 * qdot[4], 2) - pow(S3 * C4 * qdot[5] + C3 * qdot[4], 2);
  double tmp8 = (C3 * C4 * qdot[5] - S3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  double tmp9 = (C3 * C4 * qdot[5] - S3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  double tmp10 = (S3 * C4 * qdot[5] + C3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  double tmp11 = (S3 * C4 * qdot[5] + C3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  ...
  double tmp16 = (S3 * C4 * qdot[5] + C3 * qdot[4]) * (0.2800000e7 / 0.3e1 * C3 * C4 * qdot[5] - 0.2800000e7 / 0.3e1 * S3 * qdot[4]) - (C3 * C4 * qdot[5] - S3 * qdot[4]) * (0.4270000e7 / 0.3e1 * S3 * C4 * qdot[5] + 0.4270000e7 / 0.3e1 * C3 * qdot[4]);
  ...
  double tmp18 = (qdot[3] - S4 * qdot[5]) * (0.4270000e7 / 0.3e1 * S3 * C4 * qdot[5] + 0.4270000e7 / 0.3e1 * C3 * qdot[4]) - (S3 * C4 * qdot[5] + C3 * qdot[4]) * (0.2030000e7 / 0.3e1 * qdot[3] - 0.2030000e7 / 0.3e1 * S4 * qdot[5]);
  double tmp19 = qdot[3] - S4 * qdot[5];
  double tmp20 = C6 * (S3 * C4 * qdot[5] + C3 * qdot[4]) + S6 * (C3 * C4 * qdot[5] - S3 * qdot[4]);
  double tmp21 = -S6 * (S3 * C4 * qdot[5] + C3 * qdot[4]) + C6 * (C3 * C4 * qdot[5] - S3 * qdot[4]);
  double tmp22 = tmp21 * qdot[6];
  double tmp23 = -tmp20 * qdot[6];
  double tmp24 = tmp1 + 62 * tmp7 - 10 * tmp11;
  double tmp25 = C6 * (tmp2 + 62 * tmp10 - 10 * tmp12) + S6 * (tmp3 + 62 * tmp8 - 10 * tmp5);
  double tmp26 = -S6 * (tmp2 + 62 * tmp10 - 10 * tmp12) + C6 * (tmp3 + 62 * tmp8 - 10 * tmp5);
  double tmp27 = -tmp20 * tmp20 - pow(tmp19 + qdot[6], 2);
  double tmp29 = tmp21 * tmp20;
  double tmp32 = tmp22 + tmp21 * (tmp19 + qdot[6]);
  ...
  double tmp46 = C7 * (tmp24 - 53 * tmp32) - S7 * (tmp26 - 53 * tmp27);
  double tmp47 = tmp25 - 53 * tmp29;
  double tmp48 = S7 * (tmp24 - 53 * tmp32) + C7 * (tmp26 - 53 * tmp27);
  ...
  double tmp68 = C9 * (tmp46 - 15 * tmp56) + S9 * (tmp47 - 15 * tmp57);
  double tmp69 = -S9 * (tmp46 - 15 * tmp56) + C9 * (tmp47 - 15 * tmp57);
  ...
  double tmp112 = C8 * (tmp24 + 53 * tmp32) - S8 * (tmp26 + 53 * tmp27);
  double tmp113 = tmp25 + 53 * tmp29;
  double tmp114 = S8 * (tmp24 + 53 * tmp32) + C8 * (tmp26 + 53 * tmp27);
  ...
  double tmp134 = C10 * (tmp112 - 15 * tmp122) + S10 * (tmp113 - 15 * tmp123);
  double tmp135 = -S10 * (tmp112 - 15 * tmp122) + C10 * (tmp113 - 15 * tmp123);
  ...
  double tmp190 = C11 * (tmp1 - 40 * tmp7 - 10 * tmp11 - 53 * tmp9) + S11 * (tmp2 - 40 * tmp10 - 10 * tmp12 - 53 * tmp6);
  double tmp191 = -S11 * (tmp1 - 40 * tmp7 - 10 * tmp11 - 53 * tmp9) + C11 * (tmp2 - 40 * tmp10 - 10 * tmp12 - 53 * tmp6);
  double tmp192 = tmp3 - 40 * tmp8 - 10 * tmp5 - 53 * tmp4;
  double tmp196 = -pow(tmp187 + qdot[11], 2) - tmp186 * tmp186;
  double tmp197 = -tmp189 + (tmp187 + qdot[11]) * tmp185;
  double tmp199 = tmp186 * tmp185;
  ...
  double tmp212 = C12 * (tmp190 + 30 * tmp196) - S12 * (tmp192 + 30 * tmp197);
  double tmp213 = tmp191 + 30 * tmp199;
  double tmp214 = S12 * (tmp190 + 30 * tmp196) + C12 * (tmp192 + 30 * tmp197);
  ...
  double tmp234 = C14 * (tmp212 - 15 * tmp222) + S14 * (tmp213 - 15 * tmp223);
  double tmp235 = -S14 * (tmp212 - 15 * tmp222) + C14 * (tmp213 - 15 * tmp223);
  ...
  double tmp278 = C13 * (tmp190 - 30 * tmp196) - S13 * (tmp192 - 30 * tmp197);
  double tmp279 = tmp191 - 30 * tmp199;
  double tmp280 = S13 * (tmp190 - 30 * tmp196) + C13 * (tmp192 - 30 * tmp197);
  ...
  double tmp300 = C15 * (tmp278 - 15 * tmp288) + S15 * (tmp279 - 15 * tmp289);
  double tmp301 = -S15 * (tmp278 - 15 * tmp288) + C15 * (tmp279 - 15 * tmp289);
  ...
  double tmp356 = C16 * (tmp1 - 40 * tmp7 - 10 * tmp11 + 53 * tmp9) + S16 * (tmp2 - 40 * tmp10 - 10 * tmp12 + 53 * tmp6);
  double tmp357 = -S16 * (tmp1 - 40 * tmp7 - 10 * tmp11 + 53 * tmp9) + C16 * (tmp2 - 40 * tmp10 - 10 * tmp12 + 53 * tmp6);
  double tmp358 = tmp3 - 40 * tmp8 - 10 * tmp5 + 53 * tmp4;
  double tmp362 = -pow(tmp353 + qdot[16], 2) - tmp352 * tmp352;
  double tmp363 = -tmp355 + (tmp353 + qdot[16]) * tmp351;
  double tmp365 = tmp352 * tmp351;
  ...
  double tmp378 = C17 * (tmp356 + 30 * tmp362) - S17 * (tmp358 + 30 * tmp363);
  double tmp379 = tmp357 + 30 * tmp365;
  double tmp380 = S17 * (tmp356 + 30 * tmp362) + C17 * (tmp358 + 30 * tmp363);
  ...
  double tmp400 = C19 * (tmp378 - 15 * tmp388) + S19 * (tmp379 - 15 * tmp389);
  double tmp401 = -S19 * (tmp378 - 15 * tmp388) + C19 * (tmp379 - 15 * tmp389);
  ...
  double tmp444 = C18 * (tmp356 - 30 * tmp362) - S18 * (tmp358 - 30 * tmp363);
  double tmp445 = tmp357 - 30 * tmp365;
  double tmp446 = S18 * (tmp356 - 30 * tmp362) + C18 * (tmp358 - 30 * tmp363);
  ...
  double tmp466 = C20 * (tmp444 - 15 * tmp454) + S20 * (tmp445 - 15 * tmp455);
  double tmp467 = -S20 * (tmp444 - 15 * tmp454) + C20 * (tmp445 - 15 * tmp455);
