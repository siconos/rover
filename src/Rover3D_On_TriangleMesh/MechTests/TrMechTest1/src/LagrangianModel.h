 ...
 */
extern void
ContactJacobian1(double *CJ, double *q);

extern void
ContactJacobian2(double *CJ, double *q);

extern void
ContactJacobian3(double *CJ, double *q);

extern void
ContactJacobian4(double *CJ, double *q);

extern void
ContactJacobian5(double *CJ, double *q);

extern void
ContactJacobian6(double *CJ, double *q);

extern void ContactJacobian1s(double *CJ,double *AngleT, double *q);

extern void ContactJacobian2s(double *CJ,double *AngleT, double *q);

extern void ContactJacobian3s(double *CJ,double *AngleT, double *q);

extern void ContactJacobian4s(double *CJ,double *AngleT, double *q);

extern void ContactJacobian5s(double *CJ,double *AngleT, double *q);

extern void ContactJacobian6s(double *CJ,double *AngleT, double *q);
