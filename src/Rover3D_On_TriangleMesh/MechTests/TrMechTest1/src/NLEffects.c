...
double qdot[21];
{
  ...
  double tmp5 = (C4 * S3 * qdot[5] + C3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  double tmp6 = -pow(C3 * C4 * qdot[5] - S3 * qdot[4], 2) - pow(C4 * S3 * qdot[5] + C3 * qdot[4], 2);
  double tmp7 = (C4 * S3 * qdot[5] + C3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  double tmp8 = (C3 * C4 * qdot[5] - S3 * qdot[4]) * (C4 * S3 * qdot[5] + C3 * qdot[4]);
  double tmp9 = -pow(C4 * S3 * qdot[5] + C3 * qdot[4], 2) - pow(qdot[3] - S4 * qdot[5], 2);
  double tmp10 = (C3 * C4 * qdot[5] - S3 * qdot[4]) * (qdot[3] - S4 * qdot[5]);
  double tmp11 = (C3 * C4 * qdot[5] - S3 * qdot[4]) * (C4 * S3 * qdot[5] + C3 * qdot[4]);
  ...
  double tmp24 = tmp1 - 0.4139999000e0 * tmp6 - 0.16375e0 * tmp4;
  double tmp25 = C6 * (tmp2 - 0.4139999000e0 * tmp5 - 0.16375e0 * tmp11) - S6 * (tmp3 - 0.4139999000e0 * tmp10 - 0.16375e0 * tmp9);
  double tmp26 = S6 * (tmp2 - 0.4139999000e0 * tmp5 - 0.16375e0 * tmp11) + C6 * (tmp3 - 0.4139999000e0 * tmp10 - 0.16375e0 * tmp9);
  double tmp27 = tmp22 + tmp21 * (tmp19 - qdot[6]);
  double tmp28 = tmp23 + tmp20 * (tmp19 - qdot[6]);
  double tmp29 = -tmp21 * tmp21 - tmp20 * tmp20;
  double tmp30 = -tmp23 + tmp20 * (tmp19 - qdot[6]);
  double tmp31 = tmp21 * tmp20;
  double tmp32 = -tmp20 * tmp20 - pow(tmp19 - qdot[6], 2);
  double tmp33 = -tmp22 + tmp21 * (tmp19 - qdot[6]);
  double tmp34 = tmp21 * tmp20;
  double tmp35 = -tmp21 * tmp21 - pow(tmp19 - qdot[6], 2);
  ...
  double tmp46 = C7 * (tmp24 - 0.2235e0 * tmp29 + 0.601203e0 * tmp30 - 0.64092e-1 * tmp27) + S7 * (tmp25 - 0.2235e0 * tmp28 + 0.601203e0 * tmp35 - 0.64092e-1 * tmp34);
  double tmp47 = -S7 * (tmp24 - 0.2235e0 * tmp29 + 0.601203e0 * tmp30 - 0.64092e-1 * tmp27) + C7 * (tmp25 - 0.2235e0 * tmp28 + 0.601203e0 * tmp35 - 0.64092e-1 * tmp34);
  double tmp48 = tmp26 - 0.2235e0 * tmp33 + 0.601203e0 * tmp31 - 0.64092e-1 * tmp32;
  double tmp49 = tmp45 + (tmp21 + qdot[7]) * tmp42;
  double tmp54 = -tmp43 * tmp43 - tmp42 * tmp42;
  double tmp56 = -tmp44 + (tmp21 + qdot[7]) * tmp43;
  ...
  double tmp65 = C9 * (tmp46 - 0.221908e0 * tmp49) - S9 * (tmp48 - 0.221908e0 * tmp54);
  double tmp66 = tmp47 - 0.221908e0 * tmp56;
  double tmp67 = S9 * (tmp46 - 0.221908e0 * tmp49) + C9 * (tmp48 - 0.221908e0 * tmp54);
  ...
  double tmp109 = C8 * (tmp24 - 0.2235e0 * tmp29 - 0.601203e0 * tmp30 - 0.64092e-1 * tmp27) + S8 * (tmp25 - 0.2235e0 * tmp28 - 0.601203e0 * tmp35 - 0.64092e-1 * tmp34);
  double tmp110 = -S8 * (tmp24 - 0.2235e0 * tmp29 - 0.601203e0 * tmp30 - 0.64092e-1 * tmp27) + C8 * (tmp25 - 0.2235e0 * tmp28 - 0.601203e0 * tmp35 - 0.64092e-1 * tmp34);
  double tmp111 = tmp26 - 0.2235e0 * tmp33 - 0.601203e0 * tmp31 - 0.64092e-1 * tmp32;
  double tmp112 = tmp108 + (tmp21 + qdot[8]) * tmp105;
  double tmp117 = -tmp106 * tmp106 - tmp105 * tmp105;
  double tmp119 = -tmp107 + (tmp21 + qdot[8]) * tmp106;
  ...
  double tmp128 = C10 * (tmp109 - 0.221908e0 * tmp112) - S10 * (tmp111 - 0.221908e0 * tmp117);
  double tmp129 = tmp110 - 0.221908e0 * tmp119;
  double tmp130 = S10 * (tmp109 - 0.221908e0 * tmp112) + C10 * (tmp111 - 0.221908e0 * tmp117);
  ...
  double tmp184 = C11 * (tmp1 + 0.4025001000e0 * tmp6 + 0.4705e0 * tmp7 - 0.23375e0 * tmp4) - S11 * (tmp3 + 0.4025001000e0 * tmp10 + 0.4705e0 * tmp8 - 0.23375e0 * tmp9);
  double tmp185 = tmp2 + 0.4025001000e0 * tmp5 + 0.4705e0 * tmp12 - 0.23375e0 * tmp11;
  double tmp186 = S11 * (tmp1 + 0.4025001000e0 * tmp6 + 0.4705e0 * tmp7 - 0.23375e0 * tmp4) + C11 * (tmp3 + 0.4025001000e0 * tmp10 + 0.4705e0 * tmp8 - 0.23375e0 * tmp9);
  double tmp187 = tmp181 * tmp179;
  double tmp188 = tmp183 + (tmp180 + qdot[11]) * tmp179;
  double tmp189 = -tmp181 * tmp181 - pow(tmp180 + qdot[11], 2);
  double tmp190 = -tmp183 + (tmp180 + qdot[11]) * tmp179;
  double tmp191 = tmp182 + tmp181 * (tmp180 + qdot[11]);
  double tmp192 = -pow(tmp180 + qdot[11], 2) - tmp179 * tmp179;
  double tmp193 = tmp181 * tmp179;
  double tmp194 = -tmp182 + tmp181 * (tmp180 + qdot[11]);
  double tmp195 = -tmp181 * tmp181 - tmp179 * tmp179;
  ...
  double tmp206 = C12 * (tmp184 - 0.32e0 * tmp189 + 0.130703e0 * tmp190 + 0.5908e-2 * tmp187) + S12 * (tmp185 - 0.32e0 * tmp188 + 0.130703e0 * tmp195 + 0.5908e-2 * tmp194);
  double tmp207 = -S12 * (tmp184 - 0.32e0 * tmp189 + 0.130703e0 * tmp190 + 0.5908e-2 * tmp187) + C12 * (tmp185 - 0.32e0 * tmp188 + 0.130703e0 * tmp195 + 0.5908e-2 * tmp194);
  double tmp208 = tmp186 - 0.32e0 * tmp193 + 0.130703e0 * tmp191 + 0.5908e-2 * tmp192;
  double tmp209 = tmp205 + (tmp181 + qdot[12]) * tmp202;
  double tmp214 = -tmp203 * tmp203 - tmp202 * tmp202;
  double tmp216 = -tmp204 + (tmp181 + qdot[12]) * tmp203;
  ...
  double tmp225 = C14 * (tmp206 - 0.221908e0 * tmp209) - S14 * (tmp208 - 0.221908e0 * tmp214);
  double tmp226 = tmp207 - 0.221908e0 * tmp216;
  double tmp227 = S14 * (tmp206 - 0.221908e0 * tmp209) + C14 * (tmp208 - 0.221908e0 * tmp214);
  ...
  double tmp269 = C13 * (tmp184 + 0.32e0 * tmp189 + 0.130703e0 * tmp190 + 0.5908e-2 * tmp187) + S13 * (tmp185 + 0.32e0 * tmp188 + 0.130703e0 * tmp195 + 0.5908e-2 * tmp194);
  double tmp270 = -S13 * (tmp184 + 0.32e0 * tmp189 + 0.130703e0 * tmp190 + 0.5908e-2 * tmp187) + C13 * (tmp185 + 0.32e0 * tmp188 + 0.130703e0 * tmp195 + 0.5908e-2 * tmp194);
  double tmp271 = tmp186 + 0.32e0 * tmp193 + 0.130703e0 * tmp191 + 0.5908e-2 * tmp192;
  double tmp272 = tmp268 + (tmp181 + qdot[13]) * tmp265;
  double tmp277 = -tmp266 * tmp266 - tmp265 * tmp265;
  double tmp279 = -tmp267 + (tmp181 + qdot[13]) * tmp266;
  ...
  double tmp288 = C15 * (tmp269 - 0.221908e0 * tmp272) - S15 * (tmp271 - 0.221908e0 * tmp277);
  double tmp289 = tmp270 - 0.221908e0 * tmp279;
  double tmp290 = S15 * (tmp269 - 0.221908e0 * tmp272) + C15 * (tmp271 - 0.221908e0 * tmp277);
  ...
  double tmp344 = C16 * (tmp1 + 0.4025001000e0 * tmp6 - 0.4705e0 * tmp7 - 0.23375e0 * tmp4) - S16 * (tmp3 + 0.4025001000e0 * tmp10 - 0.4705e0 * tmp8 - 0.23375e0 * tmp9);
  double tmp345 = tmp2 + 0.4025001000e0 * tmp5 - 0.4705e0 * tmp12 - 0.23375e0 * tmp11;
  double tmp346 = S16 * (tmp1 + 0.4025001000e0 * tmp6 - 0.4705e0 * tmp7 - 0.23375e0 * tmp4) + C16 * (tmp3 + 0.4025001000e0 * tmp10 - 0.4705e0 * tmp8 - 0.23375e0 * tmp9);
  double tmp347 = tmp341 * tmp339;
  double tmp348 = tmp343 + (tmp340 + qdot[16]) * tmp339;
  double tmp349 = -tmp341 * tmp341 - pow(tmp340 + qdot[16], 2);
  double tmp350 = -tmp343 + (tmp340 + qdot[16]) * tmp339;
  double tmp351 = tmp342 + tmp341 * (tmp340 + qdot[16]);
  double tmp352 = -pow(tmp340 + qdot[16], 2) - tmp339 * tmp339;
  double tmp353 = tmp341 * tmp339;
  double tmp354 = -tmp342 + tmp341 * (tmp340 + qdot[16]);
  double tmp355 = -tmp341 * tmp341 - tmp339 * tmp339;
  ...
  double tmp366 = C17 * (tmp344 - 0.32e0 * tmp349 - 0.130703e0 * tmp350 + 0.5908e-2 * tmp347) + S17 * (tmp345 - 0.32e0 * tmp348 - 0.130703e0 * tmp355 + 0.5908e-2 * tmp354);
  double tmp367 = -S17 * (tmp344 - 0.32e0 * tmp349 - 0.130703e0 * tmp350 + 0.5908e-2 * tmp347) + C17 * (tmp345 - 0.32e0 * tmp348 - 0.130703e0 * tmp355 + 0.5908e-2 * tmp354);
  double tmp368 = tmp346 - 0.32e0 * tmp353 - 0.130703e0 * tmp351 + 0.5908e-2 * tmp352;
  double tmp369 = tmp365 + (tmp341 + qdot[17]) * tmp362;
  double tmp374 = -tmp363 * tmp363 - tmp362 * tmp362;
  double tmp376 = -tmp364 + (tmp341 + qdot[17]) * tmp363;
  ...
  double tmp385 = C19 * (tmp366 - 0.221908e0 * tmp369) - S19 * (tmp368 - 0.221908e0 * tmp374);
  double tmp386 = tmp367 - 0.221908e0 * tmp376;
  double tmp387 = S19 * (tmp366 - 0.221908e0 * tmp369) + C19 * (tmp368 - 0.221908e0 * tmp374);
  ...
  double tmp429 = C18 * (tmp344 + 0.32e0 * tmp349 - 0.130703e0 * tmp350 + 0.5908e-2 * tmp347) + S18 * (tmp345 + 0.32e0 * tmp348 - 0.130703e0 * tmp355 + 0.5908e-2 * tmp354);
  double tmp430 = -S18 * (tmp344 + 0.32e0 * tmp349 - 0.130703e0 * tmp350 + 0.5908e-2 * tmp347) + C18 * (tmp345 + 0.32e0 * tmp348 - 0.130703e0 * tmp355 + 0.5908e-2 * tmp354);
  double tmp431 = tmp346 + 0.32e0 * tmp353 - 0.130703e0 * tmp351 + 0.5908e-2 * tmp352;
  double tmp432 = tmp428 + (tmp341 + qdot[18]) * tmp425;
  double tmp437 = -tmp426 * tmp426 - tmp425 * tmp425;
  double tmp439 = -tmp427 + (tmp341 + qdot[18]) * tmp426;
  ...
  double tmp448 = C20 * (tmp429 - 0.221908e0 * tmp432) - S20 * (tmp431 - 0.221908e0 * tmp437);
  double tmp449 = tmp430 - 0.221908e0 * tmp439;
  double tmp450 = S20 * (tmp429 - 0.221908e0 * tmp432) + C20 * (tmp431 - 0.221908e0 * tmp437);
