...
int main(int argc, char* argv[])
{
  try
  {
    ...
    while(s->hasNextEvent())
    {
      ...
      if(dataPlot(k, 0) > 50 && dataPlot(k, 0) <= 100){
      ...
      if(dataPlot(k, 0) > 100 && dataPlot(k, 0) <= 150){
        (*Force)(9) = 50 + 0.08*k;       //FL traction
        (*Force)(10) = 50 + 0.08*k;      //FR  traction
        (*Force)(14) = 50 + 0.08*k;      //ML traction
        (*Force)(15) = 50 + 0.08*k;      //BL traction
        (*Force)(19) = 50 + 0.08*k;      //MR traction
        (*Force)(20) = 50 + 0.08*k;     //BR traction
      }

      if(dataPlot(k, 0) >= 138.365 && dataPlot(k, 0) <= 180){
        (*Force)(9) = static_torque;       //FL traction
        (*Force)(10) = static_torque;      //FR  traction
        (*Force)(14) = static_torque;      //ML traction
        (*Force)(15) = static_torque;      //BL traction
      ...
      if(dataPlot(k, 0) > 180  && dataPlot(k, 0) <= 200){
        (*Force)(9) = 50 + 0.08*(k-50);       //FL traction
        (*Force)(10) = 50 + 0.08*(k-50);      //FR  traction
        (*Force)(14) = 50 + 0.08*(k-50);      //ML traction
        (*Force)(15) = 50 + 0.08*(k-50);      //BL traction
        (*Force)(19) = 50 + 0.08*(k-50);      //MR traction
        (*Force)(20) = 50 + 0.08*(k-50);     //BR traction

      }
      if(dataPlot(k, 0) >=200){
      (*Force)(9) = sliding_torque;       //FL traction
      (*Force)(10) = sliding_torque;      //FR  traction
      (*Force)(14) = sliding_torque;      //ML traction
      (*Force)(15) = sliding_torque;      //BL traction
      (*Force)(19) = sliding_torque;      //MR traction
      (*Force)(20) = sliding_torque;     //BR traction
      }
